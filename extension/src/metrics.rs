...
impl MetricsSnapshot {
    ...
    pub fn to_prometheus(&self) -> String {
        ...
        let lines: &[(&str, &str, i64, &str)] = &[
            ...
            ("pgmqtt_messages_dropped_queue_full_total", "counter", self.msgs_dropped_queue_full, "Messages dropped due to full client queue"),
            ...
            ("pgmqtt_db_session_errors_total",      "counter", self.db_session_errors,      "DB session operation errors"),
            ("pgmqtt_db_message_errors_total",      "counter", self.db_message_errors,      "DB message operation errors"),
            ("pgmqtt_db_subscription_errors_total",  "counter", self.db_subscription_errors,  "DB subscription operation errors"),
